...
import require$$1 from '@actions/exec';
import 'which';
import require$$3 from 'compare-versions';
import require$$4 from '@actions/io';
import require$$5 from 'path';
import require$$6 from 'action-input-parser';
import require$$7 from 'node:os';
import '@actions/artifact';
import 'node:stream/consumers';
import require$$10 from 'dotenv';
import '@actions/glob';
...
function requireSrc () {
	...
	const compare_version = require$$3;
	const io = require$$4;
	const path = require$$5;
	const parser = require$$6;
	const os = require$$7;
	require$$10.config();
