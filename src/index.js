...
async function fixes()
{
  if(process.platform === "linux" && !CMakeVersionGreaterEqual('3.5.0'))
  {
    ...
    await exec.exec('apt-get -y install --no-install-recommends -y libidn12; ln /usr/lib/x86_64-linux-gnu/libidn.so.12 /usr/lib/x86_64-linux-gnu/libidn.so.11', [], options)
  }
